...
// import com.arbitrage.repository.*;
...
//                            .orElseThrow(
//                                    () -> new IllegalArgumentException("Unknown exchange: " +
// leg.getExchange()));
//
...
//                            .orElseThrow(
//                                    () -> new IllegalArgumentException("Unknown pair symbol: " +
// leg.getMarket()));
//
...
//            BucketKeyDto key = new BucketKeyDto(rl.getExchangeAccountId(),
// rl.getSpendCurrencyId());
...
//            int updated = balanceRepository.tryReserve(key.getAccountId(), key.getCurrencyId(),
// amount);
//            if (updated == 0) {
//                // rollback
...
//
//                log.warn(
//                        "Balance reservation rejected: externalId={}, signalId={}, accountId={},
// currencyId={}, required={}",
//                        dto.getSignalId(),
...
//                        key.getCurrencyId(),
//                        amount);
//                return new BalanceReservationResultDto(StepResult.fail(rej), buildPlan(resolved,
// false));
//            }
//        }
//
...
//                n,
//                bucketAmounts.size());
//        return new BalanceReservationResultDto(StepResult.ok(), plan);
//    }
//
